...
const Navbar = ({}) => {
  return (
    <header
      id="navbar"
      className="sticky top-0 z-10 flex w-full items-center justify-between border bg-secondary p-6 font-medium transition-all duration-1000 ease-in-out md:px-32 mb-16"
    >
